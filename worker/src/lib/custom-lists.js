/* Generated from scripts/lib/custom-lists.js — run npm run sync-worker-lib */
...
export { MAX_CUSTOM_LISTS, MAX_CUSTOM_LIST_MOVIES, MAX_NAME_LENGTH, MIN_NAME_LENGTH, CUSTOM_ID_PREFIX, isCustomListId, normalizeName, CUSTOM_LIST_INDEX_SORT_MODES, DEFAULT_CUSTOM_LIST_INDEX_SORT, normalizeCustomListIndexSort, normalizePinnedCustomListId, sortCustomListsForIndex, togglePinnedCustomListId, defaultCustomLists, defaultCustomListTombstones, normalizeCustomList, normalizeCustomLists, normalizeCustomListTombstones, findCustomList, customListsForMovie, isDuplicateName, isCustomListAtMovieCap, canAddMovieToCustomList, createCustomListId, createCustomList, ensureCustomListsFromImport, renameCustomList, deleteCustomList, addMovieToCustomList, removeMovieFromCustomList, replaceCustomListMovieIds };
