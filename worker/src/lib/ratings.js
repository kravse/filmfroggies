/* Generated from scripts/lib/ratings.js — run npm run sync-worker-lib */
...
export { MIN_RATING, MAX_RATING, SLIDER_MIN, SLIDER_MAX, DEFAULT_SLIDER_VALUE, normalizeRating, formatUserRating, ratingFromSliderValue, sliderValueFromRating, ratingSelectDisplayValue, ratingSelectInnerHtml, collectMovieIds, collectWatchedMovieIds, collectRateableMovieIds, isRatingAllowed, normalizeRatings, getRating, setRating, removeRating };
