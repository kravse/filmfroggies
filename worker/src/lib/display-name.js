/* Generated from scripts/lib/display-name.js — run npm run sync-worker-lib */
...
export { DISPLAY_NAME_MIN, DISPLAY_NAME_MAX, storedDisplayName, normalizeDisplayName, displayNameError, resolveDisplayName, hasCustomDisplayName };
